...
CCWeatherModule_FILES = src/WCCHostObserver.m src/WCCModule.m src/WCCContentViewController.m src/ConditionTables.m src/WCCPreferences.m src/WCCMedia.m src/WCCGallery.m src/WCCSettings.m src/WCCConfigurations.m src/WCCRegionSettings.m
