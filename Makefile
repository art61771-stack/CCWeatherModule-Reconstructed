...
CCWeatherModule_FILES = src/WCCModule.m src/WCCContentViewController.m src/ConditionTables.m src/WCCPreferences.m src/WCCMedia.m src/WCCGallery.m src/WCCGalleryBridge.m src/WCCSettings.m
