...
assert 'WCCHourlyLayoutReady(_isExpanded,self.mediaVisible,self.mediaSuspended,' in refresh
assert 'self.view.window!=nil,_hourlyScrollView.window!=nil,self.presentedViewController!=nil,' in refresh
