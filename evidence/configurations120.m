...
int main(void){@autoreleasepool{
 ...
 NSString *suite=[@"test.weather120." stringByAppendingString:NSUUID.UUID.UUIDString];
 ...
 NSMutableDictionary *target=[defaults mutableCopy];target[@"temperatureOffsetX"]=@27;target[@"mainIconCollapsedPercent"]=@150;target[@"mainIconExpandedPercent"]=@75;target[@"greetingShadow"]=@YES;target[@"customGreetingEnabled"]=@YES;target[@"customGreetingText"]=@"固定句子";
 ...
 assert(WCCCommitSliderValues(defaults));
 for(NSDictionary *v in @[@{@"greetingShadow":@1},@{@"customGreetingEnabled":@1},@{@"customGreetingEnabled":@YES,@"customGreetingText":@"  "},@{@"customGreetingText":[@"x" stringByPaddingToLength:81 withString:@"x" startingAtIndex:0]},@{@"temperatureOffsetY":@41},@{@"mainIconExpandedPercent":@101},@{@"token":@"forbidden"}]){
