...
checks=[
 ...
 'Version: 1.2.1' in (root/'control').read_text(), 'Icon: https://' in (root/'control').read_text(),
]
info=plistlib.loads((root/'Resources/Info.plist').read_bytes()); checks.extend([info['CFBundleVersion']=='121',info['CFBundleShortVersionString']=='1.2.1'])
