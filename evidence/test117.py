...
pre=(r/'evidence/hourly117-stub.inc').read_text()
post=(r/'evidence/hourly117-main.inc').read_text()
...
if '--generate' in sys.argv:
    (r/'evidence/hourly117-generated.m').write_text(out)
print('PASS 117 source linkage; Objective-C executable requires macOS Foundation; iOS16 NOT RUN')
