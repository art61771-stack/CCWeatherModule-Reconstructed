...
FOUNDATION_EXPORT NSArray<NSDictionary *> *WCCGreetingEntries(void);
FOUNDATION_EXPORT NSArray<NSString *> *WCCGreetingCandidates(void);
FOUNDATION_EXPORT BOOL WCCSaveGreetingEntry(NSString *identifier, NSString *text);
FOUNDATION_EXPORT BOOL WCCDeleteGreetingEntry(NSString *identifier);
FOUNDATION_EXPORT BOOL WCCRandomGreetingEnabled(void);
